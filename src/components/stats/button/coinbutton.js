            ...
            >
              <Paper>
                <ClickAwayListener onClickAway={handleClose}>
                  ...
                  >
                    <MenuItem onClick={handleClose} className={style.wrapper}>All chains</MenuItem>
                    <MenuItem onClick={handleClose} className={style.wrapper}>Ethereum</MenuItem>
                    <MenuItem onClick={handleClose} className={style.wrapper}>Polygon</MenuItem>
