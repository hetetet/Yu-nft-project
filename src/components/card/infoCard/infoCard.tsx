...
const InfoCard = ({ value }: InfoCardProps) => {
    return (
        <Link href={`/detail/${value?._id}`} passHref>
                ...
                <div className={style.wrapper}>
                   ...
                   <div className={style.childWrapper}>
                    <div>
                        <div className={style.name}>{value?.asset_contract.name || "Not Available"}</div>
                    
                        <div className={style.cardname}>{value?.name || "Not Available"}</div>
                    </div>
                    <div>
                        <p className={style.name}>Price</p>
                        <div className={style.cardname}>{value?.asset_contract.cost || "No value"}</div>
                    </div>
                    </div>
                    <div className={style.bottomWrap}>
                        <div className={style.title}>Buy now</div>
                        <div>
                            <img className={style.icon} src='https://freeiconshop.com/wp-content/uploads/edd/heart-outline.png'/>
                        </div>
                    </div>
                </div>
