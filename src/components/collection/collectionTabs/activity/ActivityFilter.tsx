      ...
      <div className={style.wrapper} onClick={handleClick}>
        ...
        {open ? (
          ...
          <div className={style.childMiniWrap}>
            <div className={style.buttonWrap}>Listings</div>
            <div className={style.buttonWrap}>Sales</div>
            <div className={style.buttonWrap}>Bids</div>
            <div className={style.buttonWrap}>Transfers</div>
          </div>
        )}
      </div>
