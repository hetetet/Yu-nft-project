module.exports = {
  ...
  theme: {
    ...
    colors: {
      //#region CloudHospital custom tailwind configuration
      primary: {
        DEFAULT: '#0f4c81',
      },
      footer: {
  ...
  plugins: [require('tailwind-scrollbar-hide'), require('@tailwindcss/aspect-ratio'), require('@tailwindcss/line-clamp')],
}
